...
public class TabFoodAdapter extends RecyclerView.Adapter<TabFoodAdapter.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        @BindView(R2.id.tab_food_container)
        CardView tabFoodContainer;
        @BindView(R2.id.tab_food_img)
        ImageView tabFoodImg;
        @BindView(R2.id.tab_food_title)
        TextView tabFoodTitle;
        @BindView(R2.id.tab_food_shi_mei_lin)
        TextView tabFoodShiMeiLin;
        @BindView(R2.id.tab_food_cuisine)
        TextView tabFoodCuisine;
        @BindView(R2.id.tab_food_tag)
        TextView tabFoodTag;
        @BindView(R2.id.tab_food_feature)
        TextView tabFoodFeature;
        @BindView(R2.id.tab_food_price)
        TextView tabFoodPrice;
        @BindView(R2.id.tab_food_price_container)
        LinearLayout tabFoodPriceContainer;
        @BindView(R2.id.tab_distance)
        TextView tabDistance;
        @BindView(R2.id.tab_distance_container)
        LinearLayout tabDistanceContainer;
        @BindView(R2.id.tab_food_floor_container)
