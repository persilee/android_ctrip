...
class _SearchBarState extends State<SearchBar> {
  ...
  _genHomeSearch() {
    ...
    if (widget.searchBarType == SearchBarType.home) {
      sMessage = 'assets/images/xiaoxi_white.png';
    } else {
      sMessage = 'assets/images/xiaoxi_grey.png';
    }
    return Container(
      child: Row(children: <Widget>[
        Expanded(
        ...
        _wrapTap(
            widget.rightIcon
                ? rightIcon('assets/images/kefu.png')
                : widget.isUserIcon
                    ? rightIcon('assets/images/user1.png')
                    : rightIcon(sMessage),
            widget.rightButtonClick),
      ]),
    );
